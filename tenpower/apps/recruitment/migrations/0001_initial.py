    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enterprise', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recruits', to='recruitment.Enterprise', verbose_name='企业ID')),
