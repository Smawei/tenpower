    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labels', models.ManyToManyField(related_name='questions', to='label.Label')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subs', to='label.Reply', verbose_name='父评论')),
                ('problem', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='label.Question', verbose_name='问题ID')),
