...
class Enterprise(models.Model):
    ...
    verbose_name="企业简介")
    content = models.CharField(max_length=1000, null=True, default=None,
    verbose_name="企业详细信息")
...
class Recruit(models.Model):
    ...
    address = models.CharField(max_length=100, null=True, default=None,
    verbose_name="办公地址")
    state = models.SmallIntegerField(choices=STATE_CHOICES, null=True,
    default=1, verbose_name="状态")
    labels = models.CharField(max_length=100, null=True, default=None,
    verbose_name="职位标签", help_text="多个标签以空格隔开")
    ...
    verbose_name="创建日期")
    enterprise = models.ForeignKey(Enterprise, related_name="recruits", on_delete=CASCADE,
                                   null=True, default=None, verbose_name="企业ID")
    users = models.ManyToManyField(User, symmetrical=False,
...
class City(models.Model):
    ...
    name = models.CharField(max_length=20, null=True, default=None,
                            verbose_name="城市名称")
    ishot = models.SmallIntegerField(choices=HOT_CHOICES, null=True, default=1,
                                     verbose_name="是否热门")
